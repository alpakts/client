...
const EditCompany = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: values => {
     Put(`/api/company/${id}`,values).then((res)=>{
  ...
  return (
    <>
      ...
      <p className="text-xl font-bold text-center text-slate-500" > EDIT COMPANY</p>
        ...
        <div
            ...
            >
              ...
              <div class="ml-3 text-sm font-normal">
                Company edited succesfully. You will be redirected
              </div>
            </div>
            <div ref={refe}
              id="toast-warning"
        ...
        <div className="relative z-0 w-full mb-6 group">
          ...
          <div className="relative z-0 w-full mb-6 group">
            <input
              ...
              className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-black dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
              placeholder=" "
              required onChange={formik.handleChange} value={formik.values.country}
            />
            <label
              for="floating_email"
              className="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
          ...
          <div className="relative z-0 w-full mb-6 group">
            <input
              ...
              className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-black dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
              placeholder=" "
              required onChange={formik.handleChange} value={formik.values.website}
            />
            <label
              htmlFor=""
              className="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
          ...
          <div className="relative z-0 w-full mb-6 group">
            <input
              ...
              className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-black dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
              placeholder=" "
              required onChange={formik.handleChange} value={formik.values.legalNumber}
            />
            <label
