...
const Editproducts = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: values => {
     ...
     Put(`/api/products/${id}`,values) .then((res) => {
  ...
  useEffect(()=>{
    Get("/api/products/"+id).then(s=>{
      setProduct(s.data)
      getCompanies();
      formik.initialValues={...s.data}
      formik.handleChange();
  ...
  return (
    <>
      ...
      <p ref={ref} className="text-md bg-green-600 rounded py-5 text-white" hidden={true}> product updated you will be redirected </p>
        <p ref={refe} className="text-md bg-red-600 rounded py-5 text-white " hidden={true}> An Error Occured </p>
      ...
      <div
              ...
              role="alert"
            >
              <div class="inline-flex items-centerjustify-center flex-shrink-0 w-8 h-8 text-green-500 bg-green-100 rounded-lg dark:bg-green-800 dark:text-green-200">
                <svg
                  aria-hidden="true"
                  class="w-5 h-5"
                  fill="currentColor"
              ...
              <div class="ml-3 text-sm font-normal">
                Product updated succesfully. You will be redirected
              </div>
            </div>
            <div ref={refe}
              id="toast-warning"
              class="mx-auto hidden mt-3 flex items-center w-full max-w-xs p-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800"
              role="alert"
            >
